...
let mainGame;
let url = "https://projekt-diplomski-igra-nim.com/";
...
function playGame() {
    ...
    mainGame = new NimGame(firstPlayer, boardSize, difficulty);
...
function NimGame(firstPlayer, boardSize, difficulty) {
    ...
    this.pc = new PC(this.difficulty); // Inicijalizira protivnika (računalo)
